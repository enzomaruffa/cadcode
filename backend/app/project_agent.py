...
- A part file defines a function and returns the object — it does NOT call `show()` (only scenes render). A part MAY set `part.color = Color("#rrggbb")` and declare its own `require(...)` specs inside the function.
